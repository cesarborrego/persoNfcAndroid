...
public class PersoSecure_Titulos {
	
	private static final String salt = 
			"Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos Se personaliza app para la lectura de datos por NFC Titulos";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_Titulos(){
