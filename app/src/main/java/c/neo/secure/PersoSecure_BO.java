...
public class PersoSecure_BO {
	
	private static final String salt = 
			"LaatencinenelServicioGeneraldeIdentificacinPersonal(SEGIP)vaporbuencaminoyconnotablesmejorassinlugaradudas.Laslargasfilasenelexteriordesusinstalacioneslamermadoademsqueeltiempodedicadoacadausuarioporlosfuncionariosdeesareparticinestataltambinesmenorahora.";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_BO(){
