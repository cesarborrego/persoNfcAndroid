...
public class PersoSecure_CI {
	
	private static final String salt = 
			"If you are not an intended recipient, please delete this e-mail including the attachments, and notify the sender by return mail. The unauthorized use, dissemination, distribution or reproduction of this e-mail, including attachments, is prohibited and may be unlawful.";
   
	private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_CI(){
