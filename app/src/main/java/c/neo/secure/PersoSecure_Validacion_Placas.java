...
public class PersoSecure_Validacion_Placas {
	
	private static final String salt = 
			"Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas Se personaliza app para la lectura de datos por NFC Validacion Placas ";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_Validacion_Placas(){
