...
public class PersoSecure_Froovie{
	
	private static final String salt = 
			"SowhatsgroovyaboutfrooviebenefitsSowhatsgroovyaboutfrooviebenefitsfrooviebeginsinanorchardorfarmwithcleannutrientloadedfruitsandveggies(notmixedupinasciencelab)everyavoreveryglass(OhandGMOisshortforgeneticallymodiedingredientsnotsogroovy)";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_Froovie(){
