...
public class PersoSecure_SkiData {
	
	private static final String salt = 
			"Youraccessmanagementdetermineshowsuccessfullyyourskiresortwilldevelopbecauseaboveallguestswanttohittheslopesquicklyandcomfortably";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_SkiData(){
