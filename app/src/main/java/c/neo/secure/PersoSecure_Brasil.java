...
public class PersoSecure_Brasil {

	private static final String salt =
			"NFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGYNFC brasil NEOLOGY";
    private static final int iterations = 2000;
    private static final int keyLength = 128;

	public PersoSecure_Brasil(){
