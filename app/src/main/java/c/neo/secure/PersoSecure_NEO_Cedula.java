...
public class PersoSecure_NEO_Cedula {
	
	private static final String salt =
			"Se personaliza app para la lectura de datos por NFCSe personaliza app para la lectura de datos por NFCSe personaliza app para la lectura de datos por NFCSe personaliza app para la lectura de datos por NFCSe personaliza app para la lectura de datos por NFC ";
    private static final int iterations = 2000;
    private static final int keyLength = 128;
    
	public PersoSecure_NEO_Cedula(){
