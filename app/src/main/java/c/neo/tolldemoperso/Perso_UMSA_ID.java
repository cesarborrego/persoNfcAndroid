...
import c.neo.secure.PersoSecure_Umsa;

public class Perso_UMSA_ID extends Activity {

	private final String TAG = Perso_UMSA_ID.class.getSimpleName();
	EditText edittext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_perso_umsa);
	...
	private void write(Tag tag) throws IOException, FormatException {
		...
		EditText matricula = (EditText)findViewById(R.id.carreraID);
		cadena_grabar+=matricula.getText().toString().toUpperCase(Locale.getDefault())+"|";
		EditText cedula = (EditText)findViewById(R.id.nombreID);
		cadena_grabar+=cedula.getText()+"|";
		EditText serie = (EditText)findViewById(R.id.folioID);
		cadena_grabar+=serie.getText()+"|";
		EditText seccion = (EditText)findViewById(R.id.ciID);
		cadena_grabar+=seccion.getText()+"|4";
		...
		if(cadena_grabar.isEmpty() ){
	        ...
	        PersoSecure_Umsa perso = new PersoSecure_Umsa();
	        String stringKey = perso.bin2hex(tag.getId())+"NeoUmsa";
	        try {
	        ...
	        NdefRecord relayRecord = new NdefRecord(NdefRecord.TNF_MIME_MEDIA,
	                new String("app/com.neo.umsa").getBytes(Charset.forName("US-ASCII")),
	                null, encryptedData);
	        
	        NdefRecord[] records = { relayRecord, NdefRecord.createApplicationRecord("com.neo.umsa") };
