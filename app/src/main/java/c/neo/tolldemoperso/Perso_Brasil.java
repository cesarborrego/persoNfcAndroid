...
public class Perso_Brasil extends Activity {
    ...
    private void write(Tag tag) throws IOException, FormatException {
        ...
        if (cadena_grabar.isEmpty()) {
            ...
            NdefRecord relayRecord = new NdefRecord(NdefRecord.TNF_MIME_MEDIA,
                    new String("app/com.neology.soat_mifare_brasil").getBytes(Charset.forName("US-ASCII")),
                    null, encryptedData);

            NdefRecord[] records = {relayRecord, NdefRecord.createApplicationRecord("com.neology.soat_mifare_brasil")};
