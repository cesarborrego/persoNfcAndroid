...
public class PersoCedula_BOActivity extends Activity {

	private final String TAG = PersoCedula_BOActivity.class.getSimpleName();
	EditText edittext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_perso_cedula__bo);
	...
	private void write(Tag tag) throws IOException, FormatException {
		...
		if(cadena_grabar.isEmpty() ){
	        ...
	        PersoSecure_BO perso = new PersoSecure_BO();
	        String stringKey = perso.bin2hex(tag.getId())+"NeologySEGIPDemo";
	        try {
	        ...
	        NdefRecord relayRecord = new NdefRecord(NdefRecord.TNF_MIME_MEDIA,
	                new String("app/c.neo.bosegip").getBytes(Charset.forName("US-ASCII")),
	                null, encryptedData);
	        
	        NdefRecord[] records = { relayRecord, NdefRecord.createApplicationRecord("c.neo.bosegip") };
