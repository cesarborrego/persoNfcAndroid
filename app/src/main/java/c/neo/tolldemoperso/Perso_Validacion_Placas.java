...
import c.neo.secure.PersoSecure_Validacion_Placas;

public class Perso_Validacion_Placas extends Activity {

	private final String TAG = Perso_Validacion_Placas.class.getSimpleName();
	EditText edittext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_validacion_placas);
	...
	private void write(Tag tag) throws IOException, FormatException {
		...
		EditText seccion = (EditText)findViewById(R.id.engomadoID);
		...
		if(cadena_grabar.isEmpty() ){
	        ...
	        PersoSecure_Validacion_Placas perso = new PersoSecure_Validacion_Placas();
	        String stringKey = perso.bin2hex(tag.getId())+"NeoEngomado";
	        try {
	        ...
	        NdefRecord relayRecord = new NdefRecord(NdefRecord.TNF_MIME_MEDIA,
	                new String("app/com.neo.engomado").getBytes(Charset.forName("US-ASCII")),
	                null, encryptedData);
	        
	        NdefRecord[] records = { relayRecord, NdefRecord.createApplicationRecord("com.neo.engomado") };
